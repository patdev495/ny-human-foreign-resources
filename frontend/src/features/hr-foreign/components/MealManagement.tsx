...
export const MealManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Top Header Banner */}
      <div className="workspace-module-header workspace-meal bg-gradient-to-r from-sky-700 via-sky-600 to-blue-700 text-white rounded-2xl shadow-sm p-5 sm:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 border border-sky-400/30">
